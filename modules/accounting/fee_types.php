...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($name) {
        ...
        redirectWithAlert("fee_types.php", "Fee Type added.", 'success');
    } else {
        redirectWithAlert("fee_types.php", "Fee Name is required.", 'error');
    }
}
            ...
            <?php foreach ($types as $t): ?>
                <tr>
                    ...
                    <td style="text-align: right;">
                        ...
                        <a href="#" onclick="confirmDelete(<?php echo $t['id']; ?>)" class="btn"
...
<script>
    function confirmDelete(id) {
        Modal.show({
            ...
            onConfirm: function () {
                window.location.href = 'fee_delete.php?id=' + id;
            }
        });
    }
</script>