<?php
/**
 * Visa Applications Kanban Board View
 * Drag-and-drop visa pipeline management
 */
require_once '../../app/bootstrap.php';
requireLogin();

$pageDetails = ['title' => 'Visa Applications - Kanban Board'];
require_once '../../templates/header.php';

$kanbanConfig = [
    'entity' => 'visa',
    'apiEndpoint' => '../../api/v1/kanban/index.php?path=visa'
];
?>

<div class="page-header flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
    <div>
        <h1 class="page-title">Visa Pipeline</h1>
        <p class="text-slate-500 text-sm">Track visa applications through each stage</p>
    </div>
    <div class="flex gap-3">
        ...
        <a href="add.php" class="btn btn-primary">
            <?php echo \EduCRM\Services\NavigationService::getIcon('plus', 16); ?> New Application
        </a>
    </div>
</div>
