...
// Only admin, branch_manager, and counselor can access
if (!hasRole('admin') && !hasRole('branch_manager') && !hasRole('counselor')) {
...
$branchFilter = $branchService->getBranchFilter($_SESSION['user_id'], 'a');
...
if (hasRole('admin') || hasRole('branch_manager')) {
    ...
    $appointments = $appointmentService->getAllAppointments($filters, $branchFilter);
