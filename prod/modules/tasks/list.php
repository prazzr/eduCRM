...
// Branch filter for data isolation
$branchFilter = $branchService->getBranchFilter($_SESSION['user_id'], 't');
...
if (hasRole('admin') || hasRole('branch_manager')) {
    ...
    $result = $taskService->getPaginatedTasks($filters, $currentPage, $perPage, $branchFilter);
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-left border-collapse">
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="<?php echo (hasRole('admin') || hasRole('branch_manager')) ? '8' : '7'; ?>" class="p-6 text-center text-slate-500">
