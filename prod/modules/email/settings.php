            ...
            <div>
                ...
                <select name="smtp_encryption"
                    ...
                    <option value="ssl" <?php echo ($settings['smtp_encryption'] ?? '') === 'ssl' ? 'selected' : ''; ?>>
                        SSL</option>
                    <option value="none" <?php echo ($settings['smtp_encryption'] ?? '') === 'none' ? 'selected' : ''; ?>>
                        None</option>
                </select>
            </div>
        </div>
    ...
    <div class="card">
        ...
        <div class="p-6">
            <label class="flex items-center">
                <input type="checkbox" name="email_queue_enabled" <?php echo ($settings['email_queue_enabled'] ?? 'true') === 'true' ? 'checked' : ''; ?>
                ...
                <span class="ml-3">
                    ...
                    <span class="block text-sm text-slate-500">When enabled, emails are queued and sent via cron job.
                        When disabled, emails are sent immediately.</span>
                </span>
            </label>
        </div>
    </div>
