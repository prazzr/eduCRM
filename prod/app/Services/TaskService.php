...
class TaskService
{
    ...
    public function createTask($data)
    {
        ...
        $stmt = $this->pdo->prepare("
            INSERT INTO tasks (
                ...
                priority, status, due_date, branch_id
            ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        ");
     ...
     */
    public function getPaginatedTasks(array $filters = [], int $page = 1, int $perPage = 20, string $branchFilter = ''): array
    {
