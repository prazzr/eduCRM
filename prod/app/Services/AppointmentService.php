...
class AppointmentService
{
    ...
    public function createAppointment($data)
    {
        ...
        $stmt = $this->pdo->prepare("
            INSERT INTO appointments (
                ...
                duration_minutes, location, meeting_link, status, branch_id
            ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        ");
    ...
    /**
     * Get all appointments (for admin/branch_manager)
     */
    public function getAllAppointments($filters = [], string $branchFilter = '')
    {
        $sql = "
            SELECT 
                a.*,
