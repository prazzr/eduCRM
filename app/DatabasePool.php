...
class DatabasePool
{
    ...
    /**
     * Get connection with specific options
     */
    public static function getConnection(array $options = []): \PDO
    {
...
/**
 * Usage example:
 * $pdo = \EduCRM\DatabasePool::getInstance();
...
echo "To use:\n";
echo "  1. Replace config/config.php PDO connection with \EduCRM\DatabasePool::getInstance()\n";
